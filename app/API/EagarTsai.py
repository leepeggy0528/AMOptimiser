...
T0 = 292.15                 # Initial temperature
a = 0.000046             # Thermal diffusivity
rho = 2850               # Density
cp = 900                 # Specific heat capacity
alpha_min = 0.047        # Minimal Absorptivity
sigma = 0.0000167        # Laser spot deviation
kappa = 234              # Thermal conductivity
Tm = 819.45              # Melting temperature
Tb = 2786                # Boiling temperature
thickness = 0.00003      # Powder bed thickness
visc = 0.001548           # Dynamic viscosity
tens = 0.871             # Surface tension
L = 269000               # Latent heat of fusion
...
def calc_alpha(P, alpha_min, rho, cp, Tm, sigma, v):
    x = (P * float(alpha_min)) / np.pi * rho * cp * Tm * sigma **2 * v
